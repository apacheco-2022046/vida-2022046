    ...
    const pickImage = async () => {
        ...
        //  const fileName = fileUri.split('/').pop();
          ...
          setAlerta({ ...alerta, fotoDesaparecido: result.assets[0] })
            ...
            uri: fileUri,
            name: fileName,
            type: 'image/jpg', // You might need to adjust the MIME type based on your needs
          } })/*
          // Create a FormData object to send the image as a file
         // const formData = new FormData();
          /*formData.append('fotoDesaparecido', {
            uri: fileUri,
            name: fileName,
            type: 'image/jpg', // You might need to adjust the MIME type based on your needs
          });*/
          ...
          try {
            ...
            const response = await fetch('//localhost:2880/save2', {
              method: 'POST',
              headers: {
